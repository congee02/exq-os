// 线性内存模型：内存是一个以字节为单位的，连续紧密排布的存储空间。
// 说明: https://study.com/academy/lesson/what-is-the-linear-memory-model-definition-constraints.html

#define SD_TYPE(x)              (x << 8)    // Segment Type
#define SD_CODE_DATA(x)         (x << 12)   // Descriptor Type [0=system, 1 = code or data]
#define SD_DPL(x)               (x << 13)   // Descriptor privilege level
#define SD_PRESENT(x)           (x << 15)   // Segment
#define SD_AVL(x)               (x << 20)
#define SD_64BITS(x)            (x << 21)
#define SD_32BITS(x)            (x << 22)
#define SD_4K_GRAN(x)           (x << 23)
// 参考: Intel Manual, Page 2910
...
// 参考: Intel Manual, Page 2912



// Segment Flags ; R0 - Ring0: 内核, R3 - Ring3: 用户应用程序
